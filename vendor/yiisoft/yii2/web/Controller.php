...
class Controller extends \yii\base\Controller
{
     ...
     * Set title for page.
     *
     * @param string $sPartTitle
     * @return void
     */
    public function setTitle($sPartTitle = '')
    {
        if ($sPartTitle) {
            $this->title = ($sPartTitle . ' - ' . $this->title);
        }
    }
     ...
     */
    public function json($isSuccess, $aResponse = [])
    {
        \Yii::$app->response->format = Response::FORMAT_JSON;
        $aResponse['success'] = $isSuccess;
        return $aResponse;
    }
